      ...
      <nav class="container mx-auto px-8 py-4 md:flex md:items-center md:justify-between">
        <div class="flex items-center justify-between">
          <a class="w-40 h-12" href="/2023">
            <img class ="w-40 h-12" src="{{ asset('images/proyekan_new.svg') }}" alt="Proyekan Image">
        </a>
        ...
        <div :class="isOpen ? 'flex' : 'hidden'" class="mt-2 flex-col space-y-4 md:mt-0 md:flex md:flex-row md:items-center md:space-y-0 md:space-x-10">
          <a class="transform text-gray-800 hover:text-green-400" href="#">Home</a>
          <a class="transform text-gray-800 hover:text-green-400" href="#">About Us</a>
          <a class="transform text-gray-800 hover:text-green-400" href="#">Blog</a>
          <a class="transform text-gray-800 hover:text-green-400" href="#">Service</a>
          <a class="rounded-2xl border bg-gradient-to-b from-green-300 to-green-500 px-4 py-2 text-center text-white hover:shadow-xl" href="#">Contact Us</a>
        </div>
      </nav>
    </header>
      ...
      <div class="flex justify-center">
        <div class="px-20 py-32 lg:w-1/2">
          <div class="w-full">
            ...
            <x-filament::button>Get Started</x-filament::button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-white">
      <div class="mx-auto max-w-5xl px-6 py-16 text-center">
        <div class="flex flex-col items-center justify-center">
          ...
          <div class="w-24 border-b-4 border-green-400"></div>
        </div>
      ...
      <div class="grid gap-2 md:grid-cols-4">
        <div class="relative mx-6">
          <div class="rounded-lg bg-white shadow-md">
            ...
            <div class="absolute bottom-32 right-4 rounded-xl bg-green-500 px-2 py-0.5 text-white">Category</div>
            <div class="p-6">
              <h2 class="mb-2 text-2xl font-medium text-gray-800">Blog headline 1</h2>
              <a href="#" class="text-base text-green-600">Read More </a>
            </div>
          </div>
        </div>
        <div class="relative mx-6">
        ...
        <div class="m-4 flex flex-wrap text-center">
          <div class="w-full p-4 lg:w-1/3">
            <div class="rounded-lg border-2 border-gray-200 px-4 py-6">
              <svg xmlns="http://www.w3.org/2000/svg" class="mb-3 inline-block h-20 w-20 text-green-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="bg-gray-200 px-10 py-32">
      <div class="mx-auto rounded-lg bg-white p-10 shadow md:w-3/4 lg:w-1/2">
        ...
        <form action="">
          ...
          <div class="flex justify-center">
            <button type="submit" class="rounded-xl bg-green-400 px-8 py-2 text-white">Submit</button>
          </div>
        </form>
      </div>
    </section>
